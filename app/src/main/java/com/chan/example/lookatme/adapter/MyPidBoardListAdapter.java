...
public class MyPidBoardListAdapter extends RecyclerView.Adapter<MyPidBoardListAdapter.ViewHolder>{
    ...
    public MyPidBoardListAdapter(Context context, ArrayList<BoardVo> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.fragment_my_pid_board_list_item, parent, false);
