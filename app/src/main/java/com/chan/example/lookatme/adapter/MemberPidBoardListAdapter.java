...
public class MemberPidBoardListAdapter extends RecyclerView.Adapter<MemberPidBoardListAdapter.ViewHolder>{
    ...
    public MemberPidBoardListAdapter(Context context, ArrayList<BoardVo> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_member_pid_board_list_item, parent, false);
